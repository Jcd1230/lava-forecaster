...
pub fn definition() -> VaccineGroupDefinition {
    VaccineGroupDefinition {
        ...
        completion_rules: vec![ConditionalCompletionRule {
        ...
        custom_extra_dose_hook: Some(overrides::hep_b_custom_extra_dose_hook),
        custom_completion_hook: None,
        group_selection: Some(overrides::hep_b_group_selection),
        policy: Some(Box::new(overrides::HepBPolicy)),
    }
}
